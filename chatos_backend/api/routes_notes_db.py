...
from chatos_backend.api.schemas_notes import (
    NoteCreate,
    NoteUpdate,
    NoteRead,
    NoteListResponse,
...
async def create_tasks_from_note(
    ...
    """
    from chatos_backend.services.tasks import create_tasks_from_note as create_tasks
...
async def get_tasks_for_note(
    ...
    in this note.
    """
    from chatos_backend.services.tasks import get_tasks_for_note as get_tasks
