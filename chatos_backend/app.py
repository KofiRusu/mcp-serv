...
from chatos_backend import __version__
from chatos_backend.config import STATIC_DIR, TEMPLATES_DIR, COMMAND_MODES
from chatos_backend.controllers.chat import (
    chat_endpoint,
    get_council_info,
    get_available_commands,
    stream_chat_response,
)
from chatos_backend.controllers.sandbox import get_sandbox, CodeEdit
from chatos_backend.controllers.projects import get_project_manager
from chatos_backend.controllers.attachments import get_attachment_manager
from chatos_backend.controllers.project_memory import get_project_memory_manager
from chatos_backend.controllers.model_config import get_model_config_manager, ModelConfig, ModelProvider
from chatos_backend.controllers.llm_client import get_llm_client
from chatos_backend.controllers.memory_logger import get_memory_logger, InteractionQuality
from chatos_backend.controllers.auto_trainer import get_auto_trainer, TrainingConfig
...
from chatos_backend.api.routes_training import router as training_router
from chatos_backend.api.routes_persrm_training import router as persrm_training_router
from chatos_backend.api.routes_ai_projects import router as ai_projects_router
from chatos_backend.api.routes_chat_history import router as history_router
from chatos_backend.api.routes_learning_loop import router as learning_loop_router
from chatos_backend.api.routes_terminal import router as terminal_router
from chatos_backend.api.routes_vscode import router as vscode_router
from chatos_backend.api.routes_agi import router as agi_router
from chatos_backend.api.routes_persrm_integration import router as persrm_integration_router
from chatos_backend.api.routes_notes import router as notes_router
from chatos_backend.api.routes_notes_db import router as notes_db_router
from chatos_backend.api.routes_transcripts import router as transcripts_router
from chatos_backend.api.routes_search import router as search_router
from chatos_backend.api.routes_uploads import router as uploads_router
from chatos_backend.api.routes_training_submission import router as training_submission_router
from chatos_backend.api.routes_auto_trading import router as auto_trading_router
from chatos_backend.api.routes_realtime_data import router as realtime_data_router
...
async def lifespan(app: FastAPI):
    ...
    try:
        from chatos_backend.controllers.llm_client import cleanup_llm_client
    ...
    try:
        from chatos_backend.controllers.cache import close_cache
        await close_cache()
    except Exception as e:
...
async def cache_stats():
    ...
    from chatos_backend.controllers.cache import get_cache_stats
    from chatos_backend.controllers.llm_client import get_response_cache_stats
...
async def clear_cache():
    ...
    from chatos_backend.controllers.llm_client import clear_response_cache
...
async def get_minimax_status():
    ...
    from chatos_backend.controllers.model_config import ModelProvider
    mgr = get_model_config_manager()
