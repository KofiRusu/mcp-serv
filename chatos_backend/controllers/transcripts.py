...
from chatos_backend.database.notes_models import TranscriptDB
from chatos_backend.api.schemas_notes import TranscriptCreate
...
async def process_transcript(transcript_id: int, session_id: str) -> None:
    ...
    """
    from chatos_backend.database.connection import get_session
    ...
    from chatos_backend.controllers import notes_db
    from chatos_backend.api.schemas_notes import NoteCreate
    ...
    try:
        ...
        try:
            ...
            try:
                from chatos_backend.services.memory import store_note_memory
