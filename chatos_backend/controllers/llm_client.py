...
from chatos_backend.controllers.model_config import (
    ModelConfig,
    ModelProvider,
    PROVIDER_INFO,
...
class LLMClient:
    ...
    async def _generate_dummy(
        ...
        from chatos_backend.models.dummy_model import DummyModel
    ...
    async def _generate_persrm(
        ...
        from chatos_backend.plugins.persrm_bridge import PersRMBridge, PersRMConfig
...
class ModelCouncil:
    ...
    async def _fallback_response(
        ...
        from chatos_backend.controllers.chat import chat_endpoint
