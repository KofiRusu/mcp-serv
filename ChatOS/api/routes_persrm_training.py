...
async def get_persrm_presets():
    ...
    """
    from ChatOS.training.presets import list_persrm_presets, DEFAULT_PERSRM_PRESET
...
async def get_available_models():
    ...
    """
    from ChatOS.training.presets import list_persrm_models, DEFAULT_PERSRM_MODEL
...
async def get_persrm_dataset_versions():
    ...
    from ChatOS.training.persrm_data_pipeline import (
...
async def get_generation_categories():
    ...
    """
    from ChatOS.training.persrm_data_generator import get_available_categories
...
async def generate_synthetic_data(request: GenerateDataRequest):
    ...
    **Note**: This is a long-running operation. For large datasets,
    ...
    from ChatOS.training.persrm_data_generator import generate_training_data
    import asyncio
