...
const OUTPUT_OPTIONS: Record<AutomationType, OutputOption[]> = {
  ...
  architecture: [
    { id: 'execution', name: 'Execution Engine', description: 'Execute strategy', blockType: 'output', config: {} },
    { id: 'monitoring', name: 'Monitoring', description: 'Monitor system', blockType: 'notification', config: {} },
    { id: 'json-file', name: 'JSON File', description: 'Save to file', blockType: 'output', config: { output_dir: '/app/data' } },
  ],
}
