...
const STARTER_TEMPLATES = {
  ...
  architecture: {
    ...
    description: 'Design your trading system architecture',
    blocks: [
      { type: 'source', name: 'Market Data', x: 100, y: 150 },
      { type: 'transform', name: 'Data Processor', x: 350, y: 100 },
      { type: 'indicator', name: 'Analysis', x: 350, y: 220 },
      { type: 'strategy', name: 'Strategy Logic', x: 600, y: 160 },
      { type: 'output', name: 'Execution', x: 850, y: 160 },
    ],
  },
}
  ...
  const handleDrop = useCallback((e: React.DragEvent) => {
    ...
    if (templateData) {
      try {
        ...
        if (nearbyBlock) {
          setTimeout(() => {
            onBlocksChange([...blocks, newBlock].map(b =>
              b.id === nearbyBlock.id
